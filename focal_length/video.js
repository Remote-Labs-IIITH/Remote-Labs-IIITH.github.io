        ...
        fetch(url)
            ...
            .then((data1) => {
                ...
                if (data1.items[0].snippet.liveBroadcastContent == "live") {
                    ...
                    fetch("https://youtube.googleapis.com/youtube/v3/search?channelId=UCkhGoGQTi3rT3Xd31rKE-XA&eventType=live&type=video&key=AIzaSyAwV-ZILe45AFhNwWcQ44p9h-42roXTnfg")
                        .then(response => response.json())
                        .then((data2) => {
