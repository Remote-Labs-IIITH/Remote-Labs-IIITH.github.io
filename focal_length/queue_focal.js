...
const collRef = collection(db, 'Queue_Focal');
    ...
    fetch('https://blynk.cloud/external/api/get?token=LvC6vyL_uPSpPdgnlCln0I9Vab6zcogV&v6')
        ...
        .then(data => {
            ...
            if (myJSON == "0" && Number(document.getElementById('que_pos').innerHTML) == 1) {
                deleteDoc(doc(db, "Queue_Focal", uid))
                    .then(async() => {
                        await fetch("https://blynk.cloud/external/api/update?token=LvC6vyL_uPSpPdgnlCln0I9Vab6zcogV&v6=1")
