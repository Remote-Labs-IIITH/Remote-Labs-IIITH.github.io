...
function myTimer() {
    ...
    fetch('https://blr1.blynk.cloud/external/api/get?token=LvC6vyL_uPSpPdgnlCln0I9Vab6zcogV&v0')
        ...
        .then(data => {
            ...
            if (myJSON == "0") {
                ...
                document.querySelector("#u").value = 20.0;
                document.querySelector("#v").value = 20.0;
                document.querySelector("#us").innerHTML = "20.0";
                document.querySelector("#vs").innerHTML = "20.0";
                sessionStorage.setItem('saved_val_u', 20.0);
                sessionStorage.setItem('saved_val_v', 20.0);
                saved_u_val = 7.6;
                saved_v_val = 6.5
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch("https://blr1.blynk.cloud/external/api/get?token=LvC6vyL_uPSpPdgnlCln0I9Vab6zcogV&v3")
        .then(response => response.json())
        .then(data => {
            UserFL1 = Number(JSON.stringify(data)) + 1
            // document.getElementById('count').innerHTML = `User Count : ${UserFL1}`;
        })
    ...
    inputslider_u.onmouseup = () => {
        fetch("https://blr1.blynk.cloud/external/api/update?token=LvC6vyL_uPSpPdgnlCln0I9Vab6zcogV&v1=" + value1)
    }

    inputslider_v.onmouseup = () => {
        fetch("https://blr1.blynk.cloud/external/api/update?token=LvC6vyL_uPSpPdgnlCln0I9Vab6zcogV&v2=" + value2)
    }
...
function increment(ID) {
    ...
    //     value2 = v1;
    // }
    fetch("https://blr1.blynk.cloud/external/api/update?token=LvC6vyL_uPSpPdgnlCln0I9Vab6zcogV&v" + String.fromCharCode(ID.charCodeAt(0) - 68) + "=" + v1)
...
function leave(){
    ...
    fetch("https://blr1.blynk.cloud/external/api/update?token=LvC6vyL_uPSpPdgnlCln0I9Vab6zcogV&v3=" + UserFL1)
    fetch("https://blr1.blynk.cloud/external/api/update?token=LvC6vyL_uPSpPdgnlCln0I9Vab6zcogV&v0=" + "1")
