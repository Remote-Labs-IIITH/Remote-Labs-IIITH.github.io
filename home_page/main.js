...
function vanish_exp() {
  ...
  fetch('https://blr1.blynk.cloud/external/api/isHardwareConnected?token=PjC1-u_h-OBVRuKZFKf0cQ2XVuYI_V6o')
    .then(response => response.json())
    .then(data => {
      const connection = JSON.stringify(data)
      if (connection == "true") {
        ...
        fetch('https://blr1.blynk.cloud/external/api/get?token=PjC1-u_h-OBVRuKZFKf0cQ2XVuYI_V6o&v4')
          .then(response => response.json())
          .then(data => {
            const myJSON = JSON.stringify(data)
            console.log(myJSON);
            if (myJSON == "1") {
              ...
              console.log("sarle");
              fetch('https://blr1.blynk.cloud/external/api/update?token=PjC1-u_h-OBVRuKZFKf0cQ2XVuYI_V6o&v4=1')
              console.log("ok");
            }
            console.log("not connected");
            // alert('Device 1 is currently offline, please try again later');
            fetch('https://blr1.blynk.cloud/external/api/update?token=PjC1-u_h-OBVRuKZFKf0cQ2XVuYI_V6o&v4=0')
...
function vanish_exp1() {
  ...
  fetch('https://blr1.blynk.cloud/external/api/get?token=PjC1-u_h-OBVRuKZFKf0cQ2XVuYI_V6o&v3')
    .then(response => response.json())
    .then(data => {
      const myJSON = JSON.stringify(data)
      if (myJSON == "0") {
        ...
        fetch('https://blr1.blynk.cloud/external/api/update?token=PjC1-u_h-OBVRuKZFKf0cQ2XVuYI_V6o&v3=1')
      }
...
function vanish_exp2() {
  ...
  fetch('https://blr1.blynk.cloud/external/api/isHardwareConnected?token=dNAlYuQN6r6pEX2Fn5jX9vNd29KJLjvS')// van_exp2 auth token
    .then(response => response.json())
    .then(data => {
      const connection = JSON.stringify(data)
      ...
      if (connection == "true") {
        fetch('https://blr1.blynk.cloud/external/api/get?token=dNAlYuQN6r6pEX2Fn5jX9vNd29KJLjvS&v3')
          .then(response => response.json())
          .then(data => {
            const myJSON = JSON.stringify(data)
            if (myJSON == "0") {
              ...
              // toggle it to 0 in leave session of van_exp1
              sessionStorage.setItem('tried_Exp', 1);
              location.href = "../vanish3/vanish3.html";
              fetch('https://blr1.blynk.cloud/external/api/update?token=dNAlYuQN6r6pEX2Fn5jX9vNd29KJLjvS&v3=1')
            }
            else {
              alert("Setups are already in use, try again later");
            }
        ...
        fetch('https://blr1.blynk.cloud/external/api/get?token=dNAlYuQN6r6pEX2Fn5jX9vNd29KJLjvS&v0')// device automation for van_exp2
          .then(response => response.json())
          .then(data => {
            const myJSON = JSON.stringify(data)
            console.log(myJSON);
            ...
            alert("Setups are already in use, try again later");
            fetch('https://blr1.blynk.cloud/external/api/update?token=dNAlYuQN6r6pEX2Fn5jX9vNd29KJLjvS&v0=0')
          });
      }
    })
}
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  fetch('https://blr1.blynk.cloud/external/api/get?token=PjC1-u_h-OBVRuKZFKf0cQ2XVuYI_V6o&v5')
    .then(response => response.json())
    .then(data => {
      UsersVR1 = Number(JSON.stringify(data))
    })

  fetch('https://blr1.blynk.cloud/external/api/get?token=dNAlYuQN6r6pEX2Fn5jX9vNd29KJLjvS&v5')
    .then(response => response.json())
    .then(data => {
